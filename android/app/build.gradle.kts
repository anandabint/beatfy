...
android {
    namespace = "com.anandabint.beatfy"
    ...
    defaultConfig {
        ...
        applicationId = "com.anandabint.beatfy"
    ...
    buildTypes {
        release {
            // key.properties belum ada (lihat README.md "Release build") →
            // fallback debug signing supaya build tetap jalan, bukan error.
